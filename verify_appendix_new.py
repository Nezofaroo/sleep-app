...
dest_docx = r"C:\Users\admin\OneDrive\Рабочий стол\Н.Н. Дипломка\Қосымша.docx"
...
def verify():
    ...
    with zipfile.ZipFile(dest_docx, 'r') as docx:
        ...
        if title_text == "Қосымша":
            print("PASSED: Title is 'Қосымша'")
        else:
            print(f"FAILED: Title is '{title_text}', expected 'Қосымша'")
            errors += 1
